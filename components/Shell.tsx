...
export default function Shell({ actor, children }: { actor: Actor; children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: "/seguimiento-guias", text: "Seguimiento guías", icon: ClipboardList, visible: actor.role === "admin" || actor.role === "operaciones" },
    { href: "/ingresos", text: "Ingresos de material", icon: Boxes, visible: actor.role !== "conductor" },
